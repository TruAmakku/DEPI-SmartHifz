    ...
    <div className="min-h-screen bg-[#FAF9F6] dark:bg-gray-900 flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              aria-label={
                isDark ? t("nav.lightModeTitle") : t("nav.darkModeTitle")
              }
      ...
      <main className="flex-grow max-w-3xl mx-auto w-full px-6 py-16">
        <div className="text-center mb-14">
          ...
          <p className="text-[#4A4A4A] dark:text-gray-400 text-lg">
            {t("about.subtitle")}
          </p>
        </div>

        <section className="mb-12">
          <h2 className="text-xl font-bold text-[#1B4332] dark:text-emerald-400 mb-4">
            {t("about.missionTitle")}
          </h2>
          <p className="text-[#4A4A4A] dark:text-gray-300 leading-relaxed text-base">
            {t("about.missionText")}
          </p>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-xl font-bold text-[#1B4332] dark:text-emerald-400 mb-6">
        ...
        <section className="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-8 mb-12 border border-amber-100 dark:border-amber-800/30">
          <h2 className="text-xl font-bold text-amber-800 dark:text-amber-400 mb-4">
            {t("about.projectTitle")}
          </h2>
          <p className="text-amber-900/80 dark:text-amber-300/80 leading-relaxed text-sm">
            {t("about.projectText")}
          </p>
        </section>

        <section className="text-center mb-12">
          <h2 className="text-xl font-bold text-[#1B4332] dark:text-emerald-400 mb-3">
            {t("about.contactTitle")}
          </h2>
          <p className="text-[#4A4A4A] dark:text-gray-300 mb-5">
            {t("about.contactText")}
          </p>
          <a
            href="mailto:iiakku1812@gmail.com"
        ...
        <div className="text-center">
          <Link
            to="/"
            className="text-sm text-[#1B4332] dark:text-emerald-400 hover:underline font-medium">
            {t("about.backHome")}
          </Link>
        </div>
      </main>
